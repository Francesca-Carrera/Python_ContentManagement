...
**File principale:** `Francesca_Carrera_Python_ContentManagement.ipynb`
...
Il progetto è contenuto in un unico file Jupyter Notebook (`Francesca_Carrera_Python_ContentManagement.ipynb`), strutturato in sezioni logiche:
